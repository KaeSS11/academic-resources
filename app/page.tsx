    ...
    <div className="min-h-screen bg-white dark:bg-[#121212] text-gray-900 dark:text-white transition-all duration-300 ease-in-out">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-8 py-6 sm:py-8 md:py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          ...
          className={`bg-gray-50 dark:bg-[#1E1E1E] p-4 sm:p-6 ${isAdminUser ? 'pr-10 sm:pr-12' : ''} rounded-lg cursor-pointer hover:bg-gray-100 dark:hover:bg-[#252525] transition-colors border border-gray-200 dark:border-gray-800/30 relative`}
              >
          {isAdminUser && (
            <button
              onClick={(e) => {
          ...
          <div className="mb-2">
            ...
            {project.description && (
              <p className="text-gray-600 dark:text-gray-400 text-xs sm:text-sm mb-4 break-words ml-0 sm:ml-7">{project.description}</p>
            )}
            {project.moduleName && (
